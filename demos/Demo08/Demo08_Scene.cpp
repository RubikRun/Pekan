...
namespace Demo
{
	...
	void Demo08_Scene::createCameras()
	{
	...
	void Demo08_Scene::createShapes()
	{
		createRectangles();
		createCircles();
		createCirclesStatic();
	...
	void Demo08_Scene::createRectangles()
	{
	...
	void Demo08_Scene::createCircles()
	{
		const float minDim = std::min(m_bbox.size.x, m_bbox.size.y);
	...
	void Demo08_Scene::createCirclesStatic()
	{
		const float minDim = std::min(m_bbox.size.x, m_bbox.size.y);
		const glm::vec2 radiusRange = { minDim * 0.001f, minDim * 0.006f };
		const glm::vec2 positionXRange = { m_bbox.min.x + radiusRange.y, m_bbox.max.x - radiusRange.y };
	...
	void Demo08_Scene::createTriangles()
	{
		const float minDim = std::min(m_bbox.size.x, m_bbox.size.y);
	...
	void Demo08_Scene::createPolygons()
	{
		const float minDim = std::min(m_bbox.size.x, m_bbox.size.y);
	...
	void Demo08_Scene::updateShapes(float dt)
	{
	...
	void Demo08_Scene::updateRectangles(float dt)
	{
		for (int i = 0; i < m_perShapeTypeCount; i++)
		{
	...
	void Demo08_Scene::updateCircles(float dt)
	{
		for (int i = 0; i < m_perShapeTypeCount / 2; i++)
		{
	...
	void Demo08_Scene::updateCirclesStatic(float dt)
	{
		for (int i = 0; i < m_perShapeTypeCount / 2; i++)
		{
	...
	void Demo08_Scene::updateTriangles(float dt)
	{
		for (int i = 0; i < m_perShapeTypeCount; i++)
		{
	...
	void Demo08_Scene::updatePolygons(float dt)
	{
		for (int i = 0; i < m_perShapeTypeCount; i++)
		{
	...
	void Demo08_Scene::updateLines(float dt)
	{
		for (int i = 0; i < m_perShapeTypeCount; i++)
		{
	...
	bool Demo08_Scene::onKeyPressed(const Pekan::KeyPressedEvent& event)
	{
